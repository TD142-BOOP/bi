...
import com.td.springbootinit.mapper.TextTaskMapper;
import com.td.springbootinit.utils.TxtUtils;
...
public class TextTaskServiceImpl extends ServiceImpl<TextTaskMapper, TextTask>
    ...
    @Override
    public TextTask getTextTask(MultipartFile multipartFile, GenTextByAiRequest genTextTaskByAiRequest, User loginUser) {
        ...
        //消耗积分
        Boolean creditResult = creditService.updateCredits(loginUser.getId(), CreditConstant.CREDIT_TEXT_SUCCESS);
