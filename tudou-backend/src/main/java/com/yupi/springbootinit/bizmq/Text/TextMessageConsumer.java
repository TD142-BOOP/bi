package com.yupi.springbootinit.bizmq.Text;
...
public class TextMessageConsumer {
    ...
    public void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag){
        ...
        for (TextRecord textRecord : textRecordList) {
            ...
            try {
                result = aiManager.doChat(CommonConstant.BI_MODEL_ID,textRecordService.buildUserInput(textRecord,textTask.getTextType()));
            } catch (Exception e) {
